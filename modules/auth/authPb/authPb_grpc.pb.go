...
type AuthGrpcServiceClient interface {
	...
	RolseCount(ctx context.Context, in *RolesCountReq, opts ...grpc.CallOption) (*RolesCountRes, error)
}
...
func (c *authGrpcServiceClient) RolseCount(ctx context.Context, in *RolesCountReq, opts ...grpc.CallOption) (*RolesCountRes, error) {
	out := new(RolesCountRes)
	err := c.cc.Invoke(ctx, "/AuthGrpcService/RolseCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthGrpcServiceServer interface {
	...
	RolseCount(context.Context, *RolesCountReq) (*RolesCountRes, error)
...
func (UnimplementedAuthGrpcServiceServer) RolseCount(context.Context, *RolesCountReq) (*RolesCountRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RolseCount not implemented")
}
...
func _AuthGrpcService_RolseCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RolesCountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthGrpcServiceServer).RolseCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AuthGrpcService/RolseCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthGrpcServiceServer).RolseCount(ctx, req.(*RolesCountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthGrpcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RolseCount",
			Handler:    _AuthGrpcService_RolseCount_Handler,
		},
	},
